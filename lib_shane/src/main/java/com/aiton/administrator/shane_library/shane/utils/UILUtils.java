...
public class UILUtils
{
    ...
    public static void displayImageNoAnim(String imageUrls, ImageView mImageView, boolean isCache)
    {
        initOptions(isCache);
        ImageLoader.getInstance().displayImage(imageUrls, mImageView, optionsNoCache,
                null);
    }
    ...
    private static void initOptions(boolean isCache)
    {
