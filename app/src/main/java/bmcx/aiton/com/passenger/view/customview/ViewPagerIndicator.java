...
//			canvas.drawCircle(CX + i * 3 * radiusSize, CY, radiusSize + 1, paint2);
    ...
    private void initPaint()
    {
        ...
        paint3.setColor(getResources().getColor(R.color.aiton_basic_color));
...
//		paint2.setTextSize(26);
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs)
    {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs,
                com.aiton.administrator.shane_library.R.styleable.ViewPagerIndicator);
        radiusSize = array.getDimension(
                com.aiton.administrator.shane_library.R.styleable.ViewPagerIndicator_radiusSize, 26);
        layout_position = array.getInt(com.aiton.administrator.shane_library.R.styleable.ViewPagerIndicator_layout_position, 0);
        indicatorCount = array.getInteger(com.aiton.administrator.shane_library.R.styleable.ViewPagerIndicator_indicatorCount, 5);
        array.recycle();// 释放内存
        initPaint();
    }
