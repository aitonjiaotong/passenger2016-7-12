...
public class LawProvisionsActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_law_provisions);
    ...
    private void initWebView()
    {
        ...
        mWebViewTicketNotice.loadUrl(Constant.URL.LAW_PROVISIONS);
    }
